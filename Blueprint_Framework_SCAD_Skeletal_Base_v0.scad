...
DesignStatus="sizing"; // ["sizing","fitting","printing","Fit to Printbed"]
// Variables seen by customizer

//Printplate dimensions
PrintPlate_X=250;
PrintPlate_Y=210;
PrintPlate_Z=210;
PrintPlate_Margin=2;
...
/*
    Provide all necessary settings to print all parts, aka: Number of facettes $fn, Orientation (xy-plane = printplate)
        * Prin plate settings: (X&Y-Dimension)
*/
}
if(DesignStatus=="fitting"){
    intersection(){
        ...
        Main_Assembly(16,76,"false",SHOW_PrintPlate="NO");
    }
}
if (DesignStatus=="sizing"){
    Main_Assembly(16,36,"true",SHOW_PrintPlate="NO");
}
if (DesignStatus=="Fit to Printbed"){
    PRINTPLATE_AREA(PrintPlate_X,PrintPlate_Y,PrintPlate_Z,PrintPlate_Margin){
        translate([PrintPlate_Margin/2,PrintPlate_Margin/2,PrintPlate_Margin/2]){
            Main_Assembly(36,76,"false", SHOW_PrintPlate="YES");
        }
    }
}
// ==================================
...
module Main_Assembly(LOW_RESOLUTION=12,HIGH_RESOLUTION=36,CUT_MODULES_RENDERED,SHOW_PrintPlate="YES"){
...
// =--------------------------------- Enviroment Modules ------------------------=
// ===============================================================================
// Modules that resembles the Enviroment aka the helmet where to atach a camera mount or the Dimensions of a printarea
//PRINTPLATE_AREA(PrintPlate_X=250,PrintPlate_Y=210,PrintPlate_Z=210,PrintPlate_Margin=2);
module PRINTPLATE_AREA(PrintPlate_X=250,PrintPlate_Y=210,PrintPlate_Z=210,PrintPlate_Margin=2){
COLOR=100/256;
    intersection(){
                color(c=[COLOR*1.3,COLOR*1.3,COLOR*1.3],alpha = 0.4){
                    difference(){    
                        cube([PrintPlate_X,PrintPlate_Y,PrintPlate_Z]);
                        translate([PrintPlate_Margin/2,PrintPlate_Margin/2,PrintPlate_Margin/2]){
                            cube([PrintPlate_X-PrintPlate_Margin,PrintPlate_Y-PrintPlate_Margin,PrintPlate_Z-PrintPlate_Margin]);
                        }
                    }
                }
            children();
    ...
    intersection(){ 
        difference(){
            translate([-PrintPlate_X/4,-PrintPlate_Y/4,-PrintPlate_Z/4]){
                cube([PrintPlate_X+PrintPlate_X/2,PrintPlate_Y+PrintPlate_Y/2,PrintPlate_Z/2+PrintPlate_Z/2]);
            }
            translate([0,0,0]){
                cube([PrintPlate_X,PrintPlate_Y,PrintPlate_Z]);
            }
    ...
    // Wire Frame Print Volume
    difference(){
        translate([0,0,-PrintPlate_Margin/2]){
            cube([PrintPlate_X,PrintPlate_Y,PrintPlate_Z]);
            translate([PrintPlate_Margin/2,PrintPlate_Margin/2,PrintPlate_Margin/2]){
                cube([PrintPlate_X-PrintPlate_Margin,PrintPlate_Y-PrintPlate_Margin,PrintPlate_Z-PrintPlate_Margin]);
            }
        }
        translate([PrintPlate_Margin/2,PrintPlate_Margin/2,0]){
            union(){
                translate([-PrintPlate_Margin,0,0]){
                    cube([PrintPlate_X+PrintPlate_Margin,PrintPlate_Y-PrintPlate_Margin,PrintPlate_Z-PrintPlate_Margin]);
                }
                translate([0,-PrintPlate_Margin,0]){
                    cube([PrintPlate_X-PrintPlate_Margin,PrintPlate_Y+PrintPlate_Margin,PrintPlate_Z-PrintPlate_Margin]);
                }
                translate([0,0,-PrintPlate_Margin]){
                    cube([PrintPlate_X-PrintPlate_Margin,PrintPlate_Y-PrintPlate_Margin,PrintPlate_Z+PrintPlate_Margin]);
                }
            }
        }
